...
const MARKETING_URL = 'https://beacon.blinkdev.me';
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            <BeaconLogo size={24} withWordmark sublabel="Analytics" />
            <p className="mt-3 text-sm text-muted-foreground">
              Historical repository health — track how a project&apos;s Beacon
              Score and its five pillars move over time.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <FooterColumn title="Product">
              ...
              <FooterLink href="/beacon-labs/aurora">Demo analytics</FooterLink>
            </FooterColumn>
            <FooterColumn title="Resources">
              <FooterExternal href={MARKETING_URL}>Marketing site</FooterExternal>

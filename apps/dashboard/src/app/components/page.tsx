...
/** Living style guide for the shared @beacon/ui primitives. */
        ...
        <section className="relative overflow-hidden border-b border-border/60">
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <p className="mt-2 max-w-2xl text-muted-foreground">
              Every primitive from the shared{' '}
              <code className="font-mono text-beacon">@beacon/ui</code> package —
              real and interactive, exactly as they ship in this dashboard.
            </p>
          </div>
        </section>

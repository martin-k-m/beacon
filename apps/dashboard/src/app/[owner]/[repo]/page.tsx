...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      `Historical repository health analysis for ${metadata.fullName}.`,
  };
}
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-7xl space-y-6 px-4 py-10 sm:px-6 lg:px-8">
          ...
          {/* ★ Signature feature: historical health trend */}
          {health && health.series.length > 0 && (
            <Reveal>
              <HealthTrend series={health.series} now={health.now} initialRange={health.range} />
            </Reveal>
          )}
